    ...
    return (
        <>
            ...
            <div className="Business-plans">
                ...
                <p className="Business-plans-detail">شروع به کار با لنـدریـک که می تواند هر آنچه را که شما برای ایجاد آگاهی ، ایجاد ترافیک ، اتصال به آن نیاز دارید فراهم کند.</p>
